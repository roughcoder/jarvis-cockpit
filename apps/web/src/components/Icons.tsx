...
// Brand-colored engine marks (Neil 2026-07-07): small colored chat/engine icons.
export const ClaudeColor: Icon = ({ className, ...props }) => (
...
export const CodexColor: Icon = ({ className, ...props }) => (
  <svg {...props} viewBox="0 0 24 24" className={cn("shrink-0", className)}>
    <title>Codex</title>
    <path
      fill="#fff"
