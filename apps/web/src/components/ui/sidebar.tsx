...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      className={cn(
        "mx-2.5 flex min-w-0 translate-x-px flex-col gap-1 border-sidebar-border/80 border-l px-2 py-1",
        "group-data-[collapsible=icon]:hidden",
        className,
      )}
