...
const defaultEnvironmentInput = {
  ...
  processArch: "arm64",
  appVersion: "1.2.3",
  appPath: "/Applications/Jarvis Cockpit.app/Contents/Resources/app.asar",
  isPackaged: true,
  resourcesPath: "/Applications/Jarvis Cockpit.app/Contents/Resources",
...
const makeElectronAppLayer = (calls: ElectronAppCalls) =>
  Layer.succeed(ElectronApp.ElectronApp, {
    ...
    name: Effect.succeed("Jarvis Cockpit"),
  ...
  it.effect("configures app identity from the environment commit override", () => {
    ...
    return withIdentity(
      Effect.gen(function* () {
        ...
        assert.deepEqual(calls.setName, ["Jarvis Cockpit (Alpha)"]);
        assert.equal(calls.setAboutPanelOptions[0]?.applicationName, "Jarvis Cockpit (Alpha)");
