// This file mostly exists because we want dev mode to show the product name instead of "electron".
...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
export const APP_DISPLAY_NAME = isDevelopment ? "Jarvis Cockpit (Dev)" : "Jarvis Cockpit (Alpha)";
