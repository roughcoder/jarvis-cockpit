            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Jarvis Cockpit could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Jarvis Cockpit still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
