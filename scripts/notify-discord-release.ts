  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Jarvis Cockpit prerelease is available for nightly testers."
          : "A new Jarvis Cockpit latest release is available.",
...
).pipe(Command.withDescription("Post a Jarvis Cockpit release announcement to Discord."));
